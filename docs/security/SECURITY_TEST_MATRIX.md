...
| TM-04 proxy escape | Optimizer fragment/redirect tests, fixed-point encoded traversal rejection, deterministic properties, and ClusterFuzzLite | Expand the retained corpus from discovered edge cases |
...
| TM-10 release compromise | Reviewed release PR, exact-SHA CI/security finalization, checksums, SBOM and provenance workflow | Post-publication verification |
