...
function B() {
	return z(/* @__PURE__ */ Ht(R));
}
function V(e) {
	if (L) {
		if (/* @__PURE__ */ Ht(R) !== null) throw ve(), n;
		R = e;
	}
}
function xe(e = 1) {
	if (L) {
		for (var t = e, n = R; t--;) n = /* @__PURE__ */ Ht(n);
		R = n;
	}
}
function Se(e = !0) {
...
var Ke = class {
	...
	constructor(e, t, n, r) {
		...
		}, this.parent = X.b, this.transform_error = r ?? this.parent?.transform_error ?? ((e) => e), this.#i = ln(() => {
			if (L) {
				let e = this.#t;
				B();
				let t = e.data === "[!";
	...
	#v(e) {
		...
		let r = () => {
			...
			t = !0, n && ge(), this.#s !== null && _n(this.#s, () => {
				this.#s = null;
			}), this.#S(() => {
				this.#b();
			});
	...
	#y() {
		...
		e && (this.is_pending = !0, this.#o = un(() => e(this.#e)), Ne(() => {
			var e = this.#c = document.createDocumentFragment(), t = Bt();
	...
	#S(e) {
		var t = X, n = Y, r = H;
		On(this.#i), Dn(this.#i), De(this.#i.ctx);
		try {
			return _t.ensure(), e();
		} catch (e) {
			return Fe(e), null;
	...
	update_pending_count(e, t) {
		this.#C(e, t), this.#l += e, !(!this.#m || this.#d) && (this.#d = !0, Ne(() => {
			this.#d = !1, this.#m && At(this.#m, this.#l);
		}));
	}
	get_effect_pending() {
	...
	#w(e) {
		this.#a &&= (mn(this.#a), null), this.#o &&= (mn(this.#o), null), this.#s &&= (mn(this.#s), null), L && (z(this.#t), xe(), z(Se()));
...
function Je() {
	var e = X, t = Y, n = H, r = U;
	return function(i = !0) {
		On(e), Dn(t), De(n), i && !(e.f & 16384) && (r?.activate(), r?.apply());
	};
}
function Ye(e = !0) {
	On(null), Dn(null), De(null), e && U?.deactivate();
}
function Xe() {
...
function $e(e, t, n) {
	let i = X;
	i === null && ce();
	var a = void 0, o = Ot(r), s = !Y, c = /* @__PURE__ */ new Set();
	return on(() => {
		var t = X, n = y();
		a = n.promise;
		try {
		...
		let u = (e, t = void 0) => {
			l?.(), c.delete(n), t !== Qe && (r.activate(), t ? (o.f |= ie, At(o, t)) : (o.f & 8388608 && (o.f ^= ie), At(o, e)), r.deactivate());
		};
...
function rt(e) {
	...
	if (!wn && i !== null && e.v !== r && i.f & 24576) return _e(), e.v;
	On(i);
	try {
		e.f &= ~k, nt(e), t = Hn(e);
	} finally {
...
function it(e) {
	var t = rt(e);
	if (!e.equals(t) && (e.wv = zn(), (!U?.is_fork || e.deps === null) && (U === null ? e.v = t : (U.capture(e, t, !0), ct?.capture(e, t, !0)), e.deps === null))) {
		Re(e, b);
		return;
	}
	wn || (lt === null ? ze(e) : (Zt() || U?.is_fork) && lt.set(e, t));
}
function at(e) {
	if (e.effects !== null) for (let t of e.effects) (t.teardown || t.ac) && (t.teardown?.(), t.ac !== null && He(() => {
		t.ac.abort(N), t.ac = null;
	}), t.fn !== null && (t.teardown = g), Wn(t, 0), fn(t));
}
function ot(e) {
...
var st = null, U = null, ct = null, lt = null, ut = null, dt = !1, ft = !1, pt = null, mt = null, ht = 0, gt = 1, _t = class e {
	...
	#_(e, t, n) {
		...
		for (var r = e.first; r !== null;) {
			...
			if (!(a && i & 1024 || i & 8192 || this.#f.has(r)) && r.fn !== null) {
				a ? r.f ^= b : i & 4 ? t.push(r) : Bn(r) && (i & 16 && this.#d.add(r), Gn(r));
				var o = r.first;
				if (o !== null) {
					r = o;
					continue;
	...
	flush() {
		try {
			...
			ht = 0, ut = null, pt = null, mt = null, ft = !1, U = null, lt = null, Et.clear();
		}
	}
	discard() {
...
function xt(e) {
	...
	if (t !== 0) {
		for (var n = 0; n < t;) {
			var r = e[n++];
			if (!(r.f & 24576) && Bn(r) && (bt = /* @__PURE__ */ new Set(), Gn(r), r.deps === null && r.first === null && r.nodes === null && r.teardown === null && r.ac === null && gn(r), bt?.size > 0)) {
				Et.clear();
				for (let e of bt) {
...
function G(e, t, n = !1) {
	return Y !== null && (!En || Y.f & 131072) && Ae() && Y.f & 4325394 && (kn === null || !kn.has(e)) && he(), At(e, n ? Pt(t) : t, mt);
}
function At(e, t, n = null) {
	if (!e.equals(t)) {
		wn ? Et.set(e, t) : Et.has(e) || Et.set(e, e.v);
		var r = _t.ensure();
		if (r.capture(e, t), e.f & 2) {
			let t = e;
			e.f & 2048 && rt(t), lt === null && ze(t);
		}
		e.wv = zn(), Nt(e, x, n), Ae() && X !== null && X.f & 1024 && !(X.f & 96) && (Nn === null ? Pn([e]) : Nn.push(e)), !r.is_fork && Tt.size > 0 && !Dt && jt();
	}
	return t;
}
function jt() {
...
function Nt(e, t, n) {
	...
	if (r !== null) for (var i = Ae(), a = r.length, o = 0; o < a; o++) {
		...
		if (!(!i && s === X)) {
			var l = (c & x) === 0;
			if (l && Re(s, t), c & 131072) Tt.add(s);
			else if (c & 2) {
				var u = s;
				lt?.delete(u), c & 65536 || (c & 512 && (X === null || !(X.f & 2097152)) && (s.f |= k), Nt(u, S, n));
			} else if (l) {
				var d = s;
...
function Pt(e) {
	...
	let t = m(e);
	if (t !== f && t !== p) return e;
	var n = /* @__PURE__ */ new Map(), i = a(e), o = /* @__PURE__ */ kt(0), s = null, c = Ln, l = (e) => {
		if (Ln === c) return e();
		var t = Y, n = Ln;
		Dn(null), Rn(c);
		var r = e();
	...
	return i && n.set("length", /* @__PURE__ */ kt(e.length, s)), new Proxy(e, {
		...
		get(t, i, a) {
			...
			if (o === void 0 && (!c || u(t, i)?.writable) && (o = l(() => /* @__PURE__ */ kt(Pt(c ? t[i] : r), s)), n.set(i, o)), o !== void 0) {
				var d = Z(o);
				return d === r ? void 0 : d;
			}
		...
		has(e, t) {
			...
			return (i !== void 0 || X !== null && (!a || u(e, t)?.writable)) && (i === void 0 && (i = l(() => /* @__PURE__ */ kt(a ? Pt(e[t]) : r, s)), n.set(t, i)), Z(i) === r) ? !1 : a;
		},
		set(e, t, a, c) {
			var d = n.get(t), f = t in e;
			if (i && t === "length") for (var p = a; p < d.v; p += 1) {
				var m = n.get(p + "");
				m === void 0 ? p in e && (m = l(() => /* @__PURE__ */ kt(r, s)), n.set(p + "", m)) : G(m, r);
			}
			if (d === void 0) (!f || u(e, t)?.writable) && (d = l(() => /* @__PURE__ */ kt(void 0, s)), G(d, Pt(a)), n.set(t, d));
			else {
				f = d.v !== r;
				var h = l(() => Pt(a));
				G(d, h);
...
function zt() {
	if (Ft === void 0) {
		Ft = window, It = /Firefox/.test(navigator.userAgent);
		var e = Element.prototype, t = Node.prototype, n = Text.prototype;
		Lt = u(t, "firstChild").get, Rt = u(t, "nextSibling").get, h(e) && (e[A] = void 0, e[se] = null, e[j] = void 0, e.__e = void 0), h(n) && (n[M] = void 0);
	}
}
function Bt(e = "") {
...
function q(e, t = 1, n = !1) {
	let r = L ? R : e;
	for (var i; t--;) i = r, r = /* @__PURE__ */ Ht(r);
	if (!L) return r;
	if (n) {
		if (r?.nodeType !== 3) {
			var a = Bt();
...
function Xt(e, t) {
	...
	if (i !== null && (i.parent = n, n !== null && Yt(i, n), Y !== null && Y.f & 2 && !(e & 64))) {
		var a = Y;
		(a.effects ??= []).push(i);
	}
	return r;
...
function tn(e) {
	return Jt("$effect.pre"), Xt(8 | ee, e);
}
function nn(e) {
	_t.ensure();
	let t = Xt(64 | O, e);
...
function an() {
	...
	sn(() => {
		for (var t of e.l.$) {
			t.deps();
			var n = t.effect;
			n.f & 1024 && n.deps !== null && Re(n, S), Bn(n) && Gn(n), t.ran = !1;
		}
	});
}
function on(e) {
...
function mn(e, t = !0) {
	var n = !1;
	(t || e.f & 262144) && e.nodes !== null && e.nodes.end !== null && (hn(e.nodes.start, e.nodes.end), n = !0), e.f |= E, fn(e, t && !n), Wn(e, 0);
...
var kn = null;
function An(e) {
	Y !== null && (kn ??= /* @__PURE__ */ new Set()).add(e);
}
...
function Vn(e, t, n = !0) {
	...
	if (r !== null && !(kn !== null && kn.has(e))) for (var i = 0; i < r.length; i++) {
		var a = r[i];
		a.f & 2 ? Vn(a, t, !1) : t === a && (n ? Re(a, x) : a.f & 1024 && Re(a, S), St(a));
	}
}
function Hn(e) {
	var t = jn, n = Mn, r = Nn, i = Y, a = kn, o = H, s = En, c = Ln, l = e.f;
	jn = null, Mn = 0, Nn = null, Y = l & 96 ? null : e, kn = null, De(e.ctx), En = !1, Ln = ++In, e.ac !== null && (He(() => {
		e.ac.abort(N);
	}), e.ac = null);
	try {
		e.f |= ne;
		...
		if (jn !== null) {
			...
			if (Zt() && e.f & 512) for (m = Mn; m < f.length; m++) (f[m].reactions ??= []).push(e);
		} else !p && f !== null && Mn < f.length && (Wn(e, Mn), f.length = Mn);
		if (Ae() && Nn !== null && !En && f !== null && !(e.f & 6146)) for (m = 0; m < Nn.length; m++) Vn(Nn[m], e);
		if (i !== null && i !== e) {
		...
		e.f ^= ne, jn = t, Mn = n, Nn = r, Y = i, kn = a, De(o), En = s, Ln = c;
	}
}
function Un(e, t) {
	let n = t.reactions;
	...
	if (n === null && t.f & 2 && (jn === null || !s.call(jn, t))) {
		var c = t;
...
function Z(e) {
	var t = !!(e.f & 2);
	if (Sn?.add(e), Y !== null && !En && !(X !== null && X.f & 16384) && (kn === null || !kn.has(e))) {
		var n = Y.deps;
		if (Y.f & 2097152) e.rv < In && (e.rv = In, jn === null && n !== null && n[Mn] === e ? Mn++ : jn === null ? jn = [e] : jn.push(e));
		else {
	...
	if (wn && Et.has(e)) return Et.get(e);
	if (t) {
		var i = e;
		if (wn) {
			var a = i.v;
			return (!(i.f & 1024) && i.reactions !== null || Jn(i)) && (a = rt(i)), Et.set(i, a), a;
		}
		var o = !(i.f & 512) && !En && Y !== null && (Cn || !!(Y.f & 512)), c = (i.f & T) === 0;
		Bn(i) && (o && (i.f |= 512), it(i)), o && !c && (ot(i), qn(i));
	}
...
function Jn(e) {
	...
	for (let t of e.deps) if (Et.has(t) || t.f & 2 && Jn(t)) return !0;
	return !1;
}
function Q(e) {
	var t = En;
...
function Yn(e) {
	if (!(typeof e != "object" || !e || e instanceof EventTarget)) {
		if (ae in e) Xn(e);
			...
			let n = e[t];
			typeof n == "object" && n && ae in n && Xn(n);
		}
	}
}
...
function lr(e, t) {
	...
	return () => {
		if (L) return cr(R, null), R;
		i === void 0 && (i = sr(a ? e : "<!>" + e), n || (i = /* @__PURE__ */ Vt(i)));
...
function gr(e, { target: t, anchor: r, props: i = {}, events: a, context: o, intro: s = !0, transformError: l }) {
	zt();
	var u = void 0, d = nn(() => {
		var s = r ?? t.appendChild(Bt());
		Ge(s, { pending: () => {} }, (t) => {
			Oe({});
			var r = H;
			if (o && (r.c = o), a && (i.$$events = a), L && cr(t, null), u = e(t, i) || {}, L && (X.nodes.end = R, R === null || R.nodeType !== 8 || R.data !== "]")) throw ve(), n;
			ke();
		}, l);
		...
		return f(c(Qn)), $n.add(f), () => {
			for (var e of d) for (let r of [t, document]) {
				var n = hr.get(r), i = n.get(e);
				--i == 0 ? (r.removeEventListener(e, ir), n.delete(e), n.size === 0 && hr.delete(r)) : n.set(e, i);
			}
			$n.delete(f), s !== r && s.parentNode?.removeChild(s);
		};
	});
	return _r.set(u, d), u;
}
var _r = /* @__PURE__ */ new WeakMap(), vr = class {
			...
			for (let [e, r] of this.#t) {
				...
				let i = () => {
					if (Array.from(this.#e.values()).includes(e)) {
						...
						xn(r, t), t.append(Bt()), this.#n.set(e, {
							effect: r,
							fragment: t
						});
					} else mn(r);
	...
	#o = (e) => {
		...
		if (t && !this.#t.has(e) && !this.#n.has(e)) {
			if (r) {
				var i = document.createDocumentFragment(), a = Bt();
...
function yr(t) {
	H === null && F("onMount"), e && H.l !== null ? br(H).m.push(t) : $t(() => {
		let e = Q(t);
		...
		_n(n, () => {
			if (a) {
				if (a.pending.delete(n), a.done.add(n), a.pending.size === 0) {
					var t = e.outrogroups;
					Cr(e, c(a.done)), t.delete(a), t.size === 0 && (e.outrogroups = null);
				}
			} else --o;
		}, !1);
	}
...
function Cr(e, t, n = !0) {
	...
	for (var i = 0; i < t.length; i++) {
		var a = t[i];
		r?.has(a) ? (a.f |= te, xn(a, document.createDocumentFragment())) : mn(t[i], n);
	}
}
var wr;
function Tr(e, t, n, r, i, o = null) {
	var s = e, l = /* @__PURE__ */ new Map();
	if (t & 4) {
		var u = e;
		s = L ? z(/* @__PURE__ */ Vt(u)) : u.appendChild(Bt());
	}
	L && B();
	...
	function g(e) {
		v.effect.f & 16384 || (v.pending.delete(e), v.fallback = d, Dr(v, p, s, t, r), d !== null && (p.length === 0 ? d.f & 33554432 ? (d.f ^= te, kr(d, null, s)) : yn(d) : _n(d, () => {
			d = null;
		})));
	}
	function _(e) {
	...
	var v = {
		effect: ln(() => {
			...
			for (var c = /* @__PURE__ */ new Set(), u = U, v = Gt(), y = 0; y < e; y += 1) {
				L && R.nodeType === 8 && R.data === "]" && (s = R, a = !0, be(!1));
				var b = p[y], x = r(b, y), S = h ? null : l.get(x);
				S ? (S.v && At(S.v, b), S.i && At(S.i, y), v && u.unskip_effect(S.e)) : (S = Or(l, h ? s : wr ??= Bt(), b, x, y, i, t, n), h || (S.e.f |= te), l.set(x, S)), c.add(x);
			}
			if (e === 0 && o && !d && (h ? d = un(() => o(s)) : (d = un(() => o(wr ??= Bt())), d.f |= te)), e > c.size && le("", "", ""), L && e > 0 && z(Se()), !h) {
				if (m.set(u, c), v) {
...
function Dr(e, t, n, r, i) {
	var a = !!(r & 8), o = t.length, s = e.items, l = Er(e.effect.first), u, d = null, f, p = [], m = [], h, g, _, v;
	...
	for (v = 0; v < o; v += 1) {
		...
		if (_.f & 8192 && (yn(_), a && (_.nodes?.a?.unfix(), (f ??= /* @__PURE__ */ new Set()).delete(_))), _.f & 33554432) {
			if (_.f ^= te, _ === l) kr(_, null, n);
				...
				var y = d ? d.next : l;
				_ === e.effect.last && (e.effect.last = _.prev), _.prev && (_.prev.next = _.next), _.next && (_.next.prev = _.prev), Ar(e, d, _), Ar(e, _, y), kr(_, y, n), d = _, p = [], m = [], l = Er(d.next);
				continue;
			}
		}
		if (_ !== l) {
			if (u !== void 0 && u.has(_)) {
				if (p.length < m.length) {
					...
					Ar(e, S.prev, C.next), Ar(e, d, S), Ar(e, C, b), l = b, d = C, --v, p = [], m = [];
				} else u.delete(_), kr(_, l, n), Ar(e, _.prev, _.next), Ar(e, _, d === null ? e.effect.first : d.next), Ar(e, d, _), d = _;
				continue;
			}
			for (p = [], m = []; l !== null && l !== _;) (u ??= /* @__PURE__ */ new Set()).add(l), m.push(l), l = Er(l.next);
			if (l === null) continue;
		}
		_.f & 33554432 || p.push(_), d = _, l = Er(_.next);
	}
	if (e.outrogroups !== null) {
		for (let t of e.outrogroups) t.pending.size === 0 && (Cr(e, c(t.done)), e.outrogroups?.delete(t));
		e.outrogroups.size === 0 && (e.outrogroups = null);
	}
	if (l !== null || u !== void 0) {
		var w = [];
		if (u !== void 0) for (_ of u) _.f & 8192 || w.push(_);
		for (; l !== null;) !(l.f & 8192) && l !== e.fallback && w.push(l), l = Er(l.next);
		var T = w.length;
		if (T > 0) {
...
function Or(e, t, n, r, i, a, o, s) {
	var c = o & 1 ? o & 16 ? Ot(n) : /* @__PURE__ */ W(n, !1, !1) : null, l = o & 2 ? Ot(i) : null;
	return {
		v: c,
		i: l,
		e: un(() => (a(t, c ?? n, l ?? i, s), () => {
...
function Fr(e, t) {
	if (t) {
		...
		if (Array.isArray(t) ? (r = t[0], i = t[1]) : r = t, e) {
			...
			var a = !1, o = 0, s = !1, c = [];
			r && c.push(...Object.keys(r).map(Pr)), i && c.push(...Object.keys(i).map(Pr));
			var l = 0, u = -1;
			let t = e.length;
			for (var d = 0; d < t; d++) {
				var f = e[d];
		...
		return r && (n += Nr(r)), i && (n += Nr(i, !0)), n = n.trim(), n === "" ? null : n;
	}
...
var zr = Symbol("is custom element"), Br = Symbol("is html"), Vr = P ? "link" : "LINK";
function Hr(e, t, n, r) {
	var i = Ur(e);
	L && (i[t] = e.getAttribute(t), t === "src" || t === "srcset" || t === "href" && e.nodeName === Vr) || i[t] !== (i[t] = n) && (t === "loading" && (e[oe] = n), n == null ? e.removeAttribute(t) : typeof n != "string" && Gr(e).includes(t) ? e[t] = n : e.setAttribute(t, n));
}
function Ur(e) {
	return e[se] ??= {
...
var Xr = !0, Zr = "uplot", Qr = "u-hz", $r = "u-vt", ei = "u-title", ti = "u-wrap", ni = "u-under", ri = "u-over", ii = "u-axis", ai = "u-off", oi = "u-select", si = "u-cursor-x", ci = "u-cursor-y", li = "u-cursor-pt", ui = "u-legend", di = "u-live", fi = "u-inline", pi = "u-series", mi = "u-marker", hi = "u-label", gi = "u-value", _i = "width", vi = "height", yi = "top", bi = "bottom", xi = "left", Si = "right", Ci = "#000", wi = "#0000", Ti = "mousemove", Ei = "mousedown", Di = "mouseup", Oi = "mouseenter", ki = "mouseleave", Ai = "dblclick", ji = "resize", Mi = "scroll", Ni = "change", Pi = "dppxchange", Fi = "--", Ii = typeof window < "u", Li = Ii ? document : null, Ri = Ii ? window : null, zi = Ii ? navigator : null, Bi, Vi;
function Hi() {
	let e = devicePixelRatio;
	Bi != e && (Bi = e, Vi && ra(Ni, Vi, Hi), Vi = matchMedia(`(min-resolution: ${Bi - .001}dppx) and (max-resolution: ${Bi + .001}dppx)`), na(Ni, Vi, Hi), Ri.dispatchEvent(new CustomEvent(Pi)));
}
function Ui(e, t) {
	if (t != null) {
		let n = e.classList;
...
function Ki(e, t, n, r) {
	let i = Li.createElement(e);
	return t != null && Ui(i, t), n?.insertBefore(i, r), i;
}
function qi(e, t) {
	return Ki("div", e, t);
}
...
function Yi(e, t, n, r, i) {
	...
	a != Ji.get(e) && (e.style.transform = a, Ji.set(e, a), t < 0 || n < 0 || t > r || n > i ? Ui(e, ai) : Wi(e, ai));
}
var Xi = /* @__PURE__ */ new WeakMap();
function Zi(e, t, n) {
	let r = t + n;
	r != Xi.get(e) && (Xi.set(e, r), e.style.background = t, e.style.borderColor = n);
}
var Qi = /* @__PURE__ */ new WeakMap();
function $i(e, t, n, r) {
	let i = t + "" + n;
	i != Qi.get(e) && (Qi.set(e, i), e.style.height = n + "px", e.style.width = t + "px", e.style.marginLeft = r ? -t / 2 + "px" : 0, e.style.marginTop = r ? -n / 2 + "px" : 0);
}
var ea = { passive: !0 }, ta = {
	...ea,
	capture: !0
...
function na(e, t, n, r) {
	t.addEventListener(e, n, r ? ta : ea);
}
function ra(e, t, n, r) {
	t.removeEventListener(e, n, ea);
}
Ii && Hi();
function ia(e, t, n, r) {
	let i;
	n ||= 0, r ||= t.length - 1;
	let a = r <= 2147483647;
	for (; r - n > 1;) i = a ? n + r >> 1 : Ea((n + r) / 2), t[i] < e ? n = i : r = i;
...
var oa = (e) => e != null, sa = (e) => e != null && e > 0, ca = aa(oa), la = aa(sa);
function ua(e, t, n, r = 0, i = !1) {
	let a = i ? la : ca, o = i ? sa : oa;
	[t, n] = a(e, t, n);
	let s = e[t], c = e[t];
	if (t > -1) {
		if (r == 1) s = e[t], c = e[n];
...
function da(e, t, n, r) {
	...
	let o = n == 10 ? Na : Pa, s = i == 1 ? Ea : Oa, c = a == 1 ? Oa : Ea, l = s(o(Ta(e))), u = c(o(Ta(t))), d = ja(n, l), f = ja(n, u);
	return n == 10 && (l < 0 && (d = $a(d, -l)), u < 0 && (f = $a(f, -u))), r || n == 2 ? (e = d * i, t = f * a) : (e = Qa(e, d), t = Za(t, f)), [e, t];
}
function fa(e, t, n, r) {
	let i = da(e, t, n, r);
...
function _a(e, t, n, r) {
	return uo(n) ? ba(e, t, n) : (ha.pad = n, ha.soft = r ? 0 : null, ha.mode = r ? 3 : 0, ba(e, t, ga));
}
function va(e, t) {
	return e ?? t;
}
function ya(e, t, n) {
	for (t = va(t, 0), n = va(n, e.length - 1); t <= n;) {
...
function ba(e, t, n) {
	let r = n.min, i = n.max, a = va(r.pad, 0), o = va(i.pad, 0), s = va(r.hard, -La), c = va(i.hard, La), l = va(r.soft, La), u = va(i.soft, -La), d = va(r.mode, 0), f = va(i.mode, 0), p = t - e, m = Na(p), h = Aa(Ta(e), Ta(t)), g = Ta(Na(h) - m);
	(p < 1e-24 || g > 10) && (p = 0, (e == 0 || t == 0) && (p = 1e-24, d == 2 && l != La && (a = 0), f == 2 && u != -La && (o = 0)));
	let _ = p || h || 1e3, v = ja(10, Ea(Na(_))), y = $a(Qa(e - _ * (p == 0 ? e == 0 ? .1 : 1 : a), v / 10), 24), b = e >= l && (d == 1 || d == 3 && y <= l || d == 2 && y >= l) ? l : La, x = Aa(s, y < b && e >= b ? b : ka(b, y)), S = $a(Za(t + _ * (p == 0 ? t == 0 ? .1 : 1 : o), v / 10), 24), C = t <= u && (f == 1 || f == 3 && S >= u || f == 2 && S <= u) ? u : -La, w = ka(c, S > C && t <= C ? C : Aa(C, S));
	return x == w && x == 0 && (w = 100), [x, w];
}
var xa = new Intl.NumberFormat(Ii ? zi.language : "en-US"), Sa = (e) => xa.format(e), Ca = Math, wa = Ca.PI, Ta = Ca.abs, Ea = Ca.floor, Da = Ca.round, Oa = Ca.ceil, ka = Ca.min, Aa = Ca.max, ja = Ca.pow, Ma = Ca.sign, Na = Ca.log10, Pa = Ca.log2, Fa = (e, t = 1) => Ca.sinh(e) * t, Ia = (e, t = 1) => Ca.asinh(e / t), La = Infinity;
function Ra(e) {
	return (Na((e ^ e >> 31) - (e >> 31)) | 0) + 1;
}
function za(e, t, n) {
	return ka(Aa(e, t), n);
}
...
var Ha = () => {}, Ua = (e) => e, Wa = (e, t) => t, Ga = (e) => null, Ka = (e) => !0, qa = (e, t) => e == t, Ja = /\.\d*?(?=9{6,}|0{6,})/gm, Ya = (e) => {
	if (so(e) || eo.has(e)) return e;
...
function Xa(e, t) {
	return Ya($a(Ya(e / t)) * t);
}
function Za(e, t) {
	return Ya(Oa(Ya(e / t)) * t);
}
function Qa(e, t) {
	return Ya(Ea(Ya(e / t)) * t);
}
function $a(e, t = 0) {
	if (so(e)) return e;
	let n = 10 ** t;
...
function no(e, t, n, r) {
	let i = [], a = r.map(to);
	for (let o = t; o < n; o++) {
		let t = Ta(o), n = $a(ja(e, o), t);
		for (let s = 0; s < r.length; s++) {
			let c = e == 10 ? +`${r[s]}e${o}` : r[s] * n, l = (o >= 0 ? 0 : t) + (o >= a[s] ? 0 : a[s]), u = e == 10 ? c : $a(c, l);
			i.push(u), eo.set(u, l);
		}
	}
	return i;
}
var ro = {}, io = [], ao = [null, null], oo = Array.isArray, so = Number.isInteger, co = (e) => e === void 0;
function lo(e) {
...
var po = Object.getPrototypeOf(Uint8Array), mo = "__proto__";
function ho(e, t = uo) {
	let n;
	if (oo(e)) {
	...
	} else if (e instanceof po) n = e.slice();
	else if (t(e)) {
		n = {};
		for (let r in e) r != mo && (n[r] = ho(e[r], t));
	} else n = e;
	return n;
}
function go(e) {
	...
	for (let n = 1; n < t.length; n++) {
		let r = t[n];
		for (let t in r) t != mo && (uo(e[t]) ? go(e[t], ho(r[t])) : e[t] = ho(r[t]));
	}
	return e;
}
var _o = 0, vo = 1, yo = 2;
...
function xo(e, t) {
	...
	for (let n = 0; n < e.length; n++) {
		...
		for (let e = 1; e < o.length; e++) {
			let c = o[e], l = Array(i).fill(void 0), u = t ? t[n][e] : vo, d = [];
			for (let e = 0; e < c.length; e++) {
				let t = c[e], n = a.get(s[e]);
				t === null ? u != _o && (l[n] = t, u == yo && d.push(n)) : l[n] = t;
			}
			bo(l, d, i), r.push(l);
		}
	}
...
var So = typeof queueMicrotask > "u" ? (e) => Promise.resolve().then(e) : queueMicrotask;
function Co(e) {
...
var No = {
	...
	mm: (e) => jo(e.getMinutes()),
	m: (e) => e.getMinutes(),
	ss: (e) => jo(e.getSeconds()),
	s: (e) => e.getSeconds(),
...
function Po(e, t) {
	t ||= Ao;
	let n = [], r = /\{([a-z]+)\}|[^{]+/gi, i;
	for (; i = r.exec(e);) n.push(i[0][0] == "{" ? No[i[1]] : i[0]);
	return (e) => {
		let r = "";
...
var Fo = new Intl.DateTimeFormat().resolvedOptions().timeZone;
function Io(e, t) {
	let n;
	return t == "UTC" || t == "Etc/UTC" ? n = /* @__PURE__ */ new Date(+e + e.getTimezoneOffset() * 6e4) : t == Fo ? n = e : (n = new Date(e.toLocaleString("en-US", { timeZone: t })), n.setMilliseconds(e.getMilliseconds())), n;
}
var Lo = (e) => e % 1 == 0, Ro = [
	1,
	2,
	2.5,
	5
], zo = no(10, -32, 0, Ro), Bo = no(10, 0, 32, Ro), Vo = Bo.filter(Lo), Ho = zo.concat(Bo), Uo = "\n", Wo = "{YYYY}", Go = Uo + Wo, Ko = "{M}/{D}", qo = Uo + Ko, Jo = qo + "/{YY}", Yo = "{aa}", Xo = "{h}:{mm}" + Yo, Zo = Uo + Xo, Qo = ":{ss}", $o = null;
function es(e) {
	let t = e * 1e3, n = t * 60, r = n * 60, i = r * 24, a = i * 30, o = i * 365, s = (e == 1 ? no(10, 0, 3, Ro).filter(Lo) : no(10, -3, 0, Ro)).concat([
		t,
		t * 5,
		t * 10,
		t * 15,
	...
	function l(t) {
		return (s, c, l, u, d, f) => {
			let p = [], m = d >= o, h = d >= a && d < o, g = t(l), _ = $a(g * e, 3), v = us(g.getFullYear(), m ? 0 : g.getMonth(), h || m ? 1 : g.getDate()), y = $a(v * e, 3);
			if (h || m) {
				let n = h ? d / a : 0, r = m ? d / o : 0, i = _ == y ? _ : $a(us(v.getFullYear() + r, v.getMonth() + n, 1) * e, 3), s = new Date(Da(i / e)), c = s.getFullYear(), l = s.getMonth();
				for (let a = 0; i <= u; a++) {
					let o = us(c + r * a, l + n * a, 1), s = o - t($a(o * e, 3));
					i = $a((+o + s) * e, 3), i <= u && p.push(i);
				}
			} else {
				let a = d >= i ? i : d, o = y + (Ea(l) - Ea(_)) + Za(_ - y, a);
				p.push(o);
				let m = t(o), h = m.getHours() + m.getMinutes() / n + m.getSeconds() / r, g = d / r, v = f / s.axes[c]._space;
				for (; o = $a(o + d, e == 1 ? 0 : 3), !(o > u);) if (g > 1) {
					let e = Ea($a(h + g, 6)) % 24, n = t(o).getHours() - e;
					n > 1 && (n = -1), o -= n * r, h = (h + g) % 24;
					let i = p[p.length - 1];
					$a((o - i) / d, 3) * v >= .7 && p.push(o);
				} else p.push(o);
			}
			return p;
		};
...
var [ts, ns, rs] = es(1), [is, as, os] = es(.001);
no(2, -53, 53, [1]);
function ss(e, t) {
...
var fs = "{YYYY}-{MM}-{DD} {h}:{mm}{aa}";
function ps(e, t) {
	return (n, r, i, a) => a == null ? Fi : t(e(r));
}
function ms(e, t) {
	let n = e.series[t];
...
function _s(e, t) {
	let n = e.cursor.points, r = qi(), i = n.size(e, t);
	Gi(r, _i, i), Gi(r, vi, i);
	let a = i / -2;
	Gi(r, "marginLeft", a), Gi(r, "marginTop", a);
	let o = n.width(e, t, i);
	return o && Gi(r, "borderWidth", o), r;
}
function vs(e, t) {
...
var Ts = {
	...
	width: 2
}, Ds = go({}, Es, { filter: Wa }), Os = go({}, Ds, { size: 10 }), ks = go({}, Es, { show: !1 }), As = "12px system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\"", js = "bold " + As, Ms = 1.5, Ns = {
	show: !0,
	scale: "x",
	stroke: Ci,
	space: 50,
...
function Rs(e, t, n, r, i, a, o) {
	let s = [], c = eo.get(i) || 0;
	n = o ? n : $a(Za(n, i), c);
	for (let e = n; e <= r; e = $a(e + i, c)) s.push(Object.is(e, -0) ? 0 : e);
	return s;
}
function zs(e, t, n, r, i, a, o) {
	let s = [], c = e.scales[e.axes[t].scale].log;
	i = ja(c, Ea((c == 10 ? Na : Pa)(n))), c == 10 && (i = Ho[ia(i, Ho)]);
	let l = n, u = i * c;
	c == 10 && (u = Ho[ia(u, Ho)]);
	do
		s.push(l), l += i, c == 10 && !eo.has(l) && (l = $a(l, eo.get(i))), l >= u && (i = l, u = i * c, c == 10 && (u = Ho[ia(u, Ho)]));
	while (l <= r);
	return s;
}
function Bs(e, t, n, r, i, a, o) {
	let s = e.scales[e.axes[t].scale].asinh, c = r > s ? zs(e, t, Aa(s, n), r, i) : [s], l = r >= 0 && n <= 0 ? [0] : [];
	return (n < -s ? zs(e, t, Aa(s, -r), -n, i) : [s]).reverse().map((e) => -e).concat(l, c);
}
var Vs = /./, Hs = /[12357]/, Us = /[125]/, Ws = /1/, Gs = (e, t, n, r) => e.map((e, i) => t == 4 && e == 0 || i % r == 0 && n.test(e.toExponential()[+(e < 0)]) ? e : null);
function Ks(e, t, n, r, i) {
	let a = e.axes[n], o = a.scale, s = e.scales[o], c = e.valToPos, l = a._space, u = c(10, o), d = c(9, o) - u >= l ? Vs : c(7, o) - u >= l ? Hs : c(5, o) - u >= l ? Us : Ws;
	if (d == Ws) {
		let e = Ta(c(1, o) - u);
		if (e < l) return Gs(t.slice().reverse(), s.distr, d, Oa(l / e)).reverse();
	}
	return Gs(t, s.distr, d, 1);
}
function qs(e, t, n, r, i) {
	let a = e.axes[n], o = a.scale, s = a._space, c = e.valToPos, l = Ta(c(1, o) - c(2, o));
	return l < s ? Gs(t.slice().reverse(), 3, Vs, Oa(s / l)).reverse() : t;
}
function Js(e, t, n, r) {
	return r == null ? Fi : t == null ? "" : Sa(t);
}
var Ys = {
	show: !0,
	scale: "y",
...
function Xs(e, t) {
	return $a((3 + (e || 1) * 2) * t, 3);
}
function Zs(e, t) {
	let { scale: n, idxs: r } = e.series[0], i = e._data[0], a = e.valToPos(i[r[0]], n, !0), o = Ta(e.valToPos(i[r[1]], n, !0) - a) / (e.series[t].points.space * Bi);
	return r[1] - r[0] <= o;
}
var Qs = {
	scale: null,
	...
	gaps: $s,
	alpha: 1,
	facets: [go({}, Qs, { scale: "x" }), go({}, Qs, { scale: "y" })]
}, tc = {
	scale: "y",
	auto: !0,
	sorted: 0,
...
function lc(e, t, n) {
	...
	return u.ori == 0 ? n(i, c, l, u, d, g, _, f, p, m, h, vc, bc, Sc, wc, Ec) : n(i, c, l, u, d, _, g, p, f, h, m, yc, xc, Cc, Tc, Dc);
}
function uc(e, t) {
	let n = 0, r = 0, i = va(e.bands, io);
...
function fc(e, t, n, r, i, a) {
	return lc(e, t, (e, t, o, s, c, l, u, d, f, p, m) => {
		let h = e.pxRound, g = s.dir * (s.ori == 0 ? 1 : -1), _ = s.ori == 0 ? bc : xc, v, y;
		g == 1 ? (v = n, y = r) : (v = r, y = n);
...
function gc(e) {
	return e == 0 ? Ua : e == 1 ? Da : (t) => Xa(t, e);
}
function _c(e) {
	let t = e == 0 ? vc : yc, n = e == 0 ? (e, t, n, r, i, a) => {
		e.arcTo(t, n, r, i, a);
	} : (e, t, n, r, i, a) => {
		e.arcTo(n, t, i, r, a);
	}, r = e == 0 ? (e, t, n, r, i) => {
	...
	return (e, i, a, o, s, c = 0, l = 0) => {
		c == 0 && l == 0 ? r(e, i, a, o, s) : (c = ka(c, o / 2, s / 2), l = ka(l, o / 2, s / 2), t(e, i + c, a), n(e, i + o, a, i + o, a + s, c), n(e, i + o, a + s, i, a + s, l), n(e, i, a + s, i, a, l), n(e, i, a, i + o, a, c), e.closePath());
	};
}
var vc = (e, t, n) => {
	e.moveTo(t, n);
	...
	e.lineTo(n, t);
}, Sc = _c(0), Cc = _c(1), wc = (e, t, n, r, i, a) => {
	e.arc(t, n, r, i, a);
}, Tc = (e, t, n, r, i, a) => {
	e.arc(n, t, r, i, a);
}, Ec = (e, t, n, r, i, a, o) => {
...
function Oc(e) {
	return (e, t, n, r, i) => lc(e, t, (t, a, o, s, c, l, u, d, f, p, m) => {
		let { pxRound: h, points: g } = t, _, v;
		s.ori == 0 ? (_ = vc, v = wc) : (_ = yc, v = Tc);
		let y = $a(g.width * Bi, 3), b = (g.size - g.width) / 2 * Bi, x = $a(b * 2, 3), S = new Path2D(), C = new Path2D(), { left: w, top: T, width: E, height: D } = e.bbox;
		Sc(C, w - x, T - x, E + x * 2, D + x * 2);
		let O = (e) => {
			if (o[e] != null) {
				let t = h(l(a[e], s, p, d)), n = h(u(o[e], c, m, f));
				_(S, t + b, n), v(S, t, n, b, 0, wa * 2);
			}
		};
		if (i) i.forEach(O);
...
var Ac = kc(bc), jc = kc(xc);
function Mc(e) {
	let t = va(e?.alignGaps, 0);
	return (e, n, r, i) => lc(e, n, (a, o, s, c, l, u, d, f, p, m, h) => {
		[r, i] = ca(s, r, i);
		let g = a.pxRound, _ = (e) => g(u(e, c, m, f)), v = (e) => g(d(e, l, h, p)), y, b;
		c.ori == 0 ? (y = bc, b = Ac) : (y = xc, b = jc);
		...
		if (i - r >= m * 4) {
			let t = (t) => e.posToVal(t, c.key, !0), n = null, a = null, l, u, d, f = _(o[x == 1 ? r : i]), p = _(o[r]), m = _(o[i]), h = t(x == 1 ? p + 1 : m - 1);
			for (let e = x == 1 ? r : i; e >= r && e <= i; e += x) {
				let r = o[e], i = (x == 1 ? r < h : r > h) ? f : _(r), c = s[e];
				i == f ? c == null ? c === null && (w = !0) : (u = c, n == null ? (y(C, i, v(u)), l = n = a = u) : u < n ? n = u : u > a && (a = u)) : (n != null && b(C, f, v(n), v(a), v(l), v(u)), c == null ? (n = a = null, c === null && (w = !0)) : (u = c, y(C, i, v(u)), n = a = l = u), f = i, h = t(f + x));
			}
			n != null && n != a && d != f && b(C, f, v(n), v(a), v(l), v(u));
		...
		if (!a.spanGaps) {
			let l = [];
			w && l.push(...hc(o, s, r, i, x, _, t)), S.gaps = l = a.gaps(e, n, r, i, l), S.clip = pc(l, c.ori, f, p, m, h);
		}
		return E != 0 && (S.band = E == 2 ? [fc(e, n, r, i, C, -1), fc(e, n, r, i, C, 1)] : fc(e, n, r, i, C, E)), S;
	});
}
function Nc(e) {
	let t = va(e.align, 1), n = va(e.ascDesc, !1), r = va(e.alignGaps, 0), i = va(e.extend, !1);
	return (e, a, o, s) => lc(e, a, (c, l, u, d, f, p, m, h, g, _, v) => {
		[o, s] = ca(u, o, s);
		let y = c.pxRound, { left: b, width: x } = e.bbox, S = (e) => y(p(e, d, _, h)), C = (e) => y(m(e, f, v, g)), w = d.ori == 0 ? bc : xc, T = {
			stroke: new Path2D(),
			fill: null,
			clip: null,
			band: null,
		...
		if (!c.spanGaps) {
			let i = [];
			i.push(...hc(l, u, o, s, D, S, r));
			let f = c.width * Bi / 2, p = n || t == 1 ? f : -f, m = n || t == -1 ? -f : f;
			i.forEach((e) => {
				e[0] += p, e[1] += m;
			}), T.gaps = i = c.gaps(e, a, o, s, i), T.clip = pc(i, d.ori, h, g, _, v);
		}
		return ie != 0 && (T.band = ie == 2 ? [fc(e, a, o, s, E, -1), fc(e, a, o, s, E, 1)] : fc(e, a, o, s, E, ie)), T;
	});
}
function Pc(e, t, n, r, i, a, o = La) {
	if (e.length > 1) {
		let s = null;
		for (let c = 0, l = Infinity; c < e.length; c++) if (t[c] !== void 0) {
			if (s != null) {
				let t = Ta(e[c] - e[s]);
				t < l && (l = t, o = Ta(n(e[c], r, i, a) - n(e[s], r, i, a)));
			}
			s = c;
		}
	}
...
function Fc(e) {
	...
	let a = Va(i), o = 1 - t[0], s = va(t[1], La), c = va(t[2], 1), l = va(e.disp, ro), u = va(e.each, (e) => {}), { fill: d, stroke: f } = l;
	return (e, t, i, p) => lc(e, t, (m, h, g, _, v, y, b, x, S, C, w) => {
		let T = m.pxRound, E = n, D = r * Bi, O = s * Bi, ee = c * Bi, te, k;
		_.ori == 0 ? [te, k] = a(e, t) : [k, te] = a(e, t);
		let ne = _.dir * (_.ori == 0 ? 1 : -1), re = _.ori == 0 ? Sc : Cc, ie = _.ori == 0 ? u : (e, t, n, r, i, a, o) => {
			u(e, t, n, i, r, o, a);
		}, ae = va(e.bands, io).find((e) => e.series[0] == t), oe = ae == null ? 0 : ae.dir, se = m.fillTo(e, t, m.min, m.max, oe), A = T(b(se, v, w, S)), j, M, N, P = C, F = T(m.width * Bi), ce = !1, le = null, I = null, ue = null, de = null;
		...
		if (fe != null && pe != null) {
			...
			M = pe.unit == 2 ? n[0] * C : y(n[0], _, C, x) - y(0, _, C, x), P = Pc(h, g, y, _, C, x, P), N = P - M + D;
		} else P = Pc(h, g, y, _, C, x, P), N = P * o + D, M = P - N;
		N < 1 && (N = 0), F >= M / 2 && (F = 0), N < 5 && (T = Ua);
		let me = N > 0, he = P - N - (me ? F : 0);
		M = T(za(he, ee, O)), j = (E == 0 ? M / 2 : E == ne ? 0 : M) - E * ne * ((E == 0 ? D / 2 : 0) + (me ? F / 2 : 0));
		let ge = {
			stroke: null,
			fill: null,
			clip: null,
		...
		for (let n = ne == 1 ? i : p; n >= i && n <= p; n += ne) {
			...
			let i = y(_.distr != 2 || l != null ? h[n] : n, _, C, x), a = b(va(r, se), v, w, S), o = T(i - j), s = T(Aa(a, A)), c = T(ka(a, A)), u = s - c;
			if (r != null) {
				let i = r < 0 ? L : ye, a = r < 0 ? ye : L;
				ce ? (F > 0 && ue[n] != null && re(de.get(ue[n]), o, c + Ea(F / 2), M, Aa(0, u - F), i, a), le[n] != null && re(I.get(le[n]), o, c + Ea(F / 2), M, Aa(0, u - F), i, a)) : re(_e, o, c + Ea(F / 2), M, Aa(0, u - F), i, a), ie(e, t, n, o - F / 2, c, M + F, u);
			}
		}
...
function Ic(e, t) {
	let n = va(t?.alignGaps, 0);
	return (t, r, i, a) => lc(t, r, (o, s, c, l, u, d, f, p, m, h, g) => {
		[i, a] = ca(c, i, a);
		let _ = o.pxRound, v = (e) => _(d(e, l, h, p)), y = (e) => _(f(e, u, g, m)), b, x, S;
		l.ori == 0 ? (b = vc, S = bc, x = Ec) : (b = yc, S = xc, x = Dc);
		...
		if (!o.spanGaps) {
			let e = [];
			e.push(...hc(s, c, i, a, C, v, n)), O.gaps = e = o.gaps(t, r, i, a, e), O.clip = pc(e, l.ori, p, m, h, g);
		}
		return k != 0 && (O.band = k == 2 ? [fc(t, r, i, a, ee, -1), fc(t, r, i, a, ee, 1)] : fc(t, r, i, a, ee, k)), O;
	});
}
function Lc(e) {
	return Ic(Rc, e);
...
function Bc() {
	for (let e of zc) e.syncRect(!0);
}
Ii && (na(ji, Ri, Bc), na(Mi, Ri, Bc, !0), na(Pi, Ri, () => {
	nl.pxRatio = Bi;
}));
var Vc = Mc(), Hc = Oc();
function Uc(e, t, n, r) {
	return (r ? [e[0], e[1]].concat(e.slice(2)) : [e[0]].concat(e.slice(1))).map((e, r) => Gc(e, r, t, n));
}
function Wc(e, t) {
	return e.map((e, n) => n == 0 ? {} : go({}, t, e));
}
function Gc(e, t, n, r) {
	return go({}, t == 0 ? n : r, e);
}
function Kc(e, t, n) {
	return t == null ? ao : [t, n];
}
var qc = Kc;
function Jc(e, t, n) {
	return t == null ? ao : _a(t, n, pa, !0);
}
function Yc(e, t, n, r) {
	return t == null ? ao : da(t, n, e.scales[r].log, !1);
}
var Xc = Yc;
function Zc(e, t, n, r) {
	return t == null ? ao : fa(t, n, e.scales[r].log, !1);
}
var Qc = Zc;
function $c(e, t, n, r, i) {
	let a = Aa(Ra(e), Ra(t)), o = t - e, s = ia(i / r * o, n);
	do {
		let e = n[s], t = r * e / o;
		if (t >= i && a + (e < 5 ? eo.get(e) : 0) <= 17) return [e, t];
	} while (++s < n.length);
	return [0, 0];
}
function el(e) {
	let t, n;
	return e = e.replace(/(\d+)px/, (e, r) => (t = Da((n = +r) * Bi)) + "px"), [
		e,
		t,
		n
	];
...
function nl(e, t, n) {
	let r = { mode: va(e.mode, 1) }, i = r.mode;
	function a(e, t, n, r) {
		let i = t.valToPct(e);
	...
	r.status = 0;
	let l = r.root = qi(Zr);
	if (e.id != null && (l.id = e.id), Ui(l, e.class), e.title) {
		let t = qi(ei, l);
		t.textContent = e.title;
	}
	let u = Ki("canvas"), d = r.ctx = u.getContext("2d"), f = qi(ti, l);
	na("click", f, (e) => {
		e.target === m && (en != Xt || tn != Zt) && rn.click(r, e);
	}, !0);
	let p = r.under = qi(ni, f);
	f.appendChild(u);
	let m = r.over = qi(ri, f);
	e = ho(e);
	let h = +va(e.pxAlign, 1), g = gc(h);
	(e.plugins || []).forEach((t) => {
		t.opts && (e = t.opts(r, e) || e);
	});
	let _ = e.ms || .001, v = r.series = i == 1 ? Uc(e.series || [], Is, tc, !1) : Wc(e.series || [null], ec), y = r.axes = Uc(e.axes || [], Ns, Ys, !0), b = r.scales = {}, x = r.bands = e.bands || [];
	x.forEach((e) => {
		e.fill = Va(e.fill || null), e.dir = va(e.dir, -1);
	});
	...
	function T(e) {
		let t = e.distr == 3 ? (t) => Na(t > 0 ? t : e.clamp(r, t, e.min, e.max, e.key)) : e.distr == 4 ? (t) => Ia(t, e.asinh) : e.distr == 100 ? (t) => e.fwd(t) : (e) => e;
		return (n) => {
	...
	function E(t) {
		let n = b[t];
		if (n == null) {
			let r = (e.scales || ro)[t] || ro;
			if (r.from != null) {
				E(r.from);
				let e = go({}, b[r.from], r, { key: t });
				e.valToPct = T(e), b[t] = e;
			} else {
				n = b[t] = go({}, t == S ? rc : ic, r), n.key = t;
				let e = n.time, a = n.range, o = oo(a);
				if ((t != S || i == 2 && !e) && (o && (a[0] == null || a[1] == null) && (a = {
					...
					let e = a;
					a = (t, n, r) => n == null ? ao : _a(n, r, e);
				}
				n.range = Va(a || (e ? qc : t == S ? n.distr == 3 ? Xc : n.distr == 4 ? Qc : Kc : n.distr == 3 ? Yc : n.distr == 4 ? Zc : Jc)), n.auto = Va(!o && n.auto), n.clamp = Va(n.clamp || nc), n._min = n._max = null, n.valToPct = T(n);
			}
		}
	}
	...
	D.ori == 0 ? (Ui(l, Qr), ee = a, te = o) : (Ui(l, $r), ee = o, te = a);
	let k = {};
	for (let e in b) {
		let t = b[e];
	...
	let ne = e.tzDate || ((e) => new Date(Da(e / _))), re = e.fmtDate || Po, ie = _ == 1 ? rs(ne) : os(ne), ae = cs(ne, ss(_ == 1 ? ns : as, re)), oe = ps(ne, ds(fs, re)), se = [], A = r.legend = go({}, gs, e.legend), j = r.cursor = go({}, Ts, { drag: { y: i == 2 } }, e.cursor), M = A.show, N = j.show, P = A.markers;
	A.idxs = se, P.width = Va(P.width), P.dash = Va(P.dash), P.stroke = Va(P.stroke), P.fill = Va(P.fill);
	let F, ce, le, I = [], ue = [], de, fe = !1, pe = {};
	if (A.live) {
		let e = v[1] ? v[1].values : null;
		fe = e != null, de = fe ? e(r, 1, 0) : { _: 0 };
		for (let e in de) pe[e] = Fi;
	}
	if (M) {
		if (F = Ki("table", ui, l), le = Ki("tbody", null, F), A.mount(r, F), fe) {
			ce = Ki("thead", null, F, le);
			let e = Ki("tr", null, ce);
			for (var me in Ki("th", null, e), de) Ki("th", hi, e).textContent = me;
		} else Ui(F, fi), A.live && Ui(F, di);
	}
	let he = { show: !0 }, ge = { show: !1 };
	function _e(e, t) {
		if (t == 0 && (fe || !A.live || i == 2)) return ao;
		let n = [], a = Ki("tr", pi, le, le.childNodes[t]);
		Ui(a, e.class), e.show || Ui(a, ai);
		let o = Ki("th", null, a);
		if (P.show) {
			let e = qi(mi, o);
			if (t > 0) {
		...
		for (var c in e.label instanceof HTMLElement ? s.appendChild(e.label) : s.textContent = e.label, t > 0 && (P.show || (s.style.color = e.width > 0 ? P.stroke(r, t) : P.fill(r, t)), ye("click", o, (t) => {
			...
			if ((t.ctrlKey || t.metaKey) != A.isolate) {
				...
				v.forEach((t, r) => {
					r > 0 && dn(r, e ? r == n ? he : ge : he, !0, qn.setSeries);
				});
			} else dn(n, { show: !e.show }, !0, qn.setSeries);
		}, !1), We && ye(Oi, o, (t) => {
			j._lock || (Ve(t), dn(v.indexOf(e), yn, !0, qn.setSeries));
		}, !1)), de) {
			let e = Ki("td", gi, a);
	...
	function ye(e, t, n, i = !0) {
		...
		o && (na(e, t, a[e] = o), ve.set(t, a));
	}
	function L(e, t, n) {
		let r = ve.get(t) || {};
		for (let n in r) (e == null || n == e) && (ra(n, t, r[n]), delete r[n]);
		e ?? ve.delete(t);
	}
	...
	function Ie(e, t) {
		...
		let n = r.bbox;
		Ee = n.left = Xa(V * Bi, .5), H = n.top = Xa(xe * Bi, .5), De = n.width = Xa(z * Bi, .5), Oe = n.height = Xa(B * Bi, .5);
	}
	function Le() {
		let e = !1, t = 0;
		for (; !e;) {
	...
	if (j.dataIdx == null) {
		...
		n.add(void 0);
		let r = e.prox = Va(e.prox), i = e.bias ??= 0;
		j.dataIdx = (e, a, o, s) => {
			if (a == 0) return o;
			let c = o, l = r(e, a, o, s) ?? La, u = l >= 0 && l < La, d = D.ori == 0 ? z : B, f = j.left, p = t[0], m = t[a];
			if (n.has(m[o])) {
				c = null;
				let e = null, t = null, r;
			...
			} else u && Ta(f - ee(p[o], D, d, 0)) > l && (c = null);
			return c;
		};
	}
	let Ve = (e) => {
	...
	j.idxs = se, j._lock = !1;
	let He = j.points;
	He.show = Va(He.show), He.size = Va(He.size), He.stroke = Va(He.stroke), He.width = Va(He.width), He.fill = Va(He.fill);
	let Ue = r.focus = go({}, e.focus || { alpha: .3 }, j.focus), We = Ue.prox >= 0, Ge = We && He.one, Ke = [], qe = [], Je = [];
	function Ye(e, t) {
		let n = He.show(r, t);
		if (n instanceof HTMLElement) return Ui(n, li), Ui(n, e.class), Yi(n, -10, -10, z, B), m.insertBefore(n, Ke[t]), n;
	}
	function Xe(e, t) {
		if (i == 1 || t > 0) {
			let t = i == 1 && b[e.scale].time, n = e.value;
			e.value = t ? lo(n) ? ps(ne, ds(n, re)) : n || oe : n || Js, e.label = e.label || (t ? Fs : Ps);
		}
		if (Ge || t > 0) {
			e.width = e.width == null ? 1 : e.width, e.paths = e.paths || Vc || Ga, e.fillTo = Va(e.fillTo || dc), e.pxAlign = +va(e.pxAlign, h), e.pxRound = gc(e.pxAlign), e.stroke = Va(e.stroke || null), e.fill = Va(e.fill || null), e._stroke = e._fill = e._paths = e._focus = null;
			let t = Xs(Aa(1, e.width), 1), n = e.points = go({}, {
				size: t,
				width: Aa(1, t * .2),
				stroke: e.stroke,
				space: t * 2,
			...
			n.show = Va(n.show), n.filter = Va(n.filter), n.fill = Va(n.fill), n.stroke = Va(n.stroke), n.paths = Va(n.paths), n.pxAlign = e.pxAlign;
		}
		if (M) {
			let n = _e(e, t);
	...
	function Ze(e, t) {
		t ??= v.length, e = i == 1 ? Gc(e, t, Is, tc) : Gc(e, t, {}, ec), v.splice(t, 0, e), Xe(v[t], t);
	}
	r.addSeries = Ze;
	function Qe(e) {
		if (v.splice(e, 1), M) {
	...
	function et(e, t) {
		if (e._show = e.show, e.show) {
			...
			let a = i.time;
			e.size = Va(e.size), e.space = Va(e.space), e.rotate = Va(e.rotate), oo(e.incrs) && e.incrs.forEach((e) => {
				!eo.has(e) && eo.set(e, to(e));
			}), e.incrs = Va(e.incrs || (i.distr == 2 ? Vo : a ? _ == 1 ? ts : is : Ho)), e.splits = Va(e.splits || (a && i.distr == 1 ? ie : i.distr == 3 ? zs : i.distr == 4 ? Bs : Rs)), e.stroke = Va(e.stroke), e.grid.stroke = Va(e.grid.stroke), e.ticks.stroke = Va(e.ticks.stroke), e.border.stroke = Va(e.border.stroke);
			let o = e.values;
			e.values = oo(o) && !oo(o[0]) ? Va(o) : a ? oo(o) ? cs(ne, ss(o, re)) : lo(o) ? ls(ne, o) : o || ae : o || Ls, e.filter = Va(e.filter || (i.distr >= 3 && i.log == 10 ? Ks : i.distr == 3 && i.log == 2 ? qs : Wa)), e.font = el(e.font), e.labelFont = el(e.labelFont), e._size = e.size(r, null, t, 0), e._space = e._rotate = e._incrs = e._found = e._splits = e._values = null, e._size > 0 && ($e[t] = !0, e._el = qi(ii, f));
		}
	}
	function tt(e, t, n, r) {
		let [i, a, o, s] = n, c = t % 2, l = 0;
		return c == 0 && (s || a) && (l = t == 0 && !i || t == 2 && !o ? Da(Ns.size / 3) : 0), c == 1 && (i || o) && (l = t == 1 && !a || t == 3 && !s ? Da(Ys.size / 2) : 0), l;
	}
	let nt = r.padding = (e.padding || [
		...
		tt,
		tt
	]).map((e) => Va(va(e, tt))), rt = r._padding = nt.map((e, t) => e(r, t, $e, 0)), it, at = null, ot = null, st = i == 1 ? v[0].idxs : null, U = null, ct = !1;
	function lt(e, n) {
	...
	function ut() {
		ct = !0;
		let e, n;
		i == 1 && (it > 0 ? (at = st[0] = 0, ot = st[1] = it - 1, e = t[0][at], n = t[0][ot], O == 2 ? (e = at, n = ot) : e == n && (O == 3 ? [e, n] = da(e, e, D.log, !1) : O == 4 ? [e, n] = fa(e, e, D.log, !1) : D.time ? n = e + Da(86400 / _) : [e, n] = _a(e, n, pa, !0))) : (at = st[0] = e = null, ot = st[1] = n = null)), un(S, e, n);
	}
	let dt, ft, pt, mt, ht, gt, _t, vt, yt, bt;
	function xt(e, t, n, r, i, a) {
		e ??= wi, n ??= io, r ??= "butt", i ??= wi, a ??= "round", e != dt && (d.strokeStyle = dt = e), i != ft && (d.fillStyle = ft = i), t != pt && (d.lineWidth = pt = t), a != ht && (d.lineJoin = ht = a), r != gt && (d.lineCap = gt = r), n != mt && d.setLineDash(mt = n);
	}
	function St(e, t, n, r) {
	...
	function Ct(e, t, n, i, a = 0) {
		if (i.length > 0 && e.auto(r, ct) && (t == null || t.min == null)) {
			let t = va(at, 0), r = va(ot, i.length - 1), o = n.min == null ? ua(i, t, r, a, e.distr == 3) : [n.min, n.max];
			e.min = ka(e.min, n.min = o[0]), e.max = Aa(e.max, n.max = o[1]);
		}
	}
	let wt = {
		min: null,
	...
	function Tt() {
		...
		for (let t in k) {
			...
			if (n != null) {
				let a = e[t] = ho(b[t], fo);
				if (n.min != null) go(a, n);
				else if (t != S || i == 2) {
					if (it == 0 && a.from == null) {
						let e = a.range(r, null, null, t);
						a.min = e[0], a.max = e[1];
					} else a.min = La, a.max = -Infinity;
				}
			}
		}
		if (it > 0) {
			v.forEach((n, a) => {
				if (i == 1) {
					...
					if (a == 0) {
						...
						s.min = e[0], s.max = e[1], at = ia(s.min, t[0]), ot = ia(s.max, t[0]), ot - at > 1 && (t[0][at] < s.min && at++, t[0][ot] > s.max && ot--), n.min = U[at], n.max = U[ot];
			...
			for (let t in e) {
				...
				if (n.from == null && (i == null || i.min == null)) {
					let e = n.range(r, n.min == La ? null : n.min, n.max == -Infinity ? null : n.max, t);
					n.min = e[0], n.max = e[1];
				}
			}
		}
		...
		for (let t in e) {
			...
			if (i.min != r.min || i.max != r.max) {
				...
				let e = i.distr;
				i._min = e == 3 ? Na(i.min) : e == 4 ? Ia(i.min, i.asinh) : e == 100 ? i.fwd(i.min) : i.min, i._max = e == 3 ? Na(i.max) : e == 4 ? Ia(i.max, i.asinh) : e == 100 ? i.fwd(i.max) : i.max, n[t] = a = !0;
			}
		}
		if (a) {
			v.forEach((e, t) => {
	...
	function Et(e) {
		let t = za(at - 1, 0, it - 1), n = za(ot + 1, 0, it - 1);
		for (; e[t] == null && t > 0;) t--;
	...
	function kt(e, t) {
		...
		t ? G(s, l, n.dash, n.cap, c, r, i, o, a) : W(e, s, l, n.dash, n.cap, c, r, i, o, u, a), p && d.translate(-f, -f);
	}
	function W(e, n, i, a, o, s, c, l, u, d, f) {
		let p = !1;
		u != 0 && x.forEach((m, h) => {
			if (m.series[0] == e) {
				let e = v[m.series[1]], g = t[m.series[1]], _ = (e._paths || ro).band;
				oo(_) && (_ = m.dir == 1 ? _[0] : _[1]);
				let y, b = null;
				e.show && _ && ya(g, at, ot) ? (b = m.fill(r, h) || s, y = e._paths.clip) : _ = null, G(n, i, a, o, b, c, l, u, d, f, y, _), p = !0;
			}
		}), p || G(n, i, a, o, s, c, l, u, d, f);
	}
	function G(e, t, n, r, i, a, o, s, c, l, u, f) {
		xt(e, t, n, r, i), (c || l || f) && (d.save(), c && d.clip(c), l && d.clip(l)), f ? (s & 3) == 3 ? (d.clip(f), u && d.clip(u), jt(i, o), At(e, a, t)) : s & cc ? (jt(i, o), d.clip(f), At(e, a, t)) : s & sc && (d.save(), d.clip(f), u && d.clip(u), jt(i, o), d.restore(), At(e, a, t)) : (jt(i, o), At(e, a, t)), (c || l || f) && d.restore();
	}
	function At(e, t, n) {
	...
	function Mt(e, t, n, i) {
		...
		if (i <= 0) o = [0, 0];
			...
			o = $c(t, n, a._incrs = a.incrs(r, e, t, n, i, s), i, s);
		}
		return a._found = o;
	}
	...
	function Pt(e) {
		...
		return y.forEach((n, i) => {
			...
			let _ = n._size;
			n._size = Oa(n.size(r, g, i, e)), _ != null && n._size != _ && (t = !1);
		}), t;
	}
	function Ft(e) {
		let t = !0;
	...
	function It() {
		for (let e = 0; e < y.length; e++) {
			...
			if (t.label != null) {
				let s = t.labelGap * l, p = Da((t._lpos + s) * Bi);
				St(t.labelFont[0], c, "center", n == 2 ? yi : bi), d.save(), i == 1 ? (a = o = 0, d.translate(p, Da(H + Oe / 2)), d.rotate((n == 3 ? -wa : wa) / 2)) : (a = Da(Ee + De / 2), o = p);
				let m = Ba(t.label) ? t.label(r, e, u, f) : t.label;
				d.fillText(m, a, o), d.restore();
			}
			if (f == 0) continue;
			let p = b[t.scale], m = i == 0 ? De : Oe, h = i == 0 ? Ee : H, _ = t._splits, v = p.distr == 2 ? _.map((e) => U[e]) : _, x = p.distr == 2 ? U[_[1]] - U[_[0]] : u, S = t.ticks, C = t.border, w = S.show ? S.size : 0, T = Da(w * Bi), E = Da((t.alignTo == 2 ? t._size - w - t.gap : t.gap) * Bi), D = t._rotate * -wa / 180, O = g(t._pos * Bi), ee = O + (T + E) * l;
			o = i == 0 ? ee : 0, a = i == 1 ? ee : 0;
			let te = t.font[0];
			St(te, c, t.align == 1 ? xi : t.align == 2 ? Si : D > 0 ? xi : D < 0 ? Si : i == 0 ? "center" : n == 3 ? Si : xi, D || i == 1 ? "middle" : n == 2 ? yi : bi);
			...
			S.show && Nt(ne, S.filter(r, v, e, f, x), i, n, O, T, $a(S.width * Bi, 3), S.stroke(r, e), S.dash, S.cap);
			let ie = t.grid;
			ie.show && Nt(ne, ie.filter(r, v, e, f, x), i, i == 0 ? 2 : 1, i == 0 ? H : Ee, i == 0 ? Oe : De, $a(ie.width * Bi, 3), ie.stroke(r, e), ie.dash, ie.cap), C.show && Nt([O], [1], +(i == 0), i == 0 ? 1 : 2, i == 1 ? H : Ee, i == 1 ? Oe : De, $a(C.width * Bi, 3), C.stroke(r, e), C.dash, C.cap);
		}
		Kn("drawAxes");
	}
	function Lt(e) {
	...
	function K(e, t = !1) {
		Rt = !0, zt = t, e(r), Ut(), t && Bt.length > 0 && queueMicrotask(Vt);
	}
	r.batch = K;
	function Ut() {
		if (ke &&= (Tt(), !1), je &&= (Le(), !1), Ae) {
			if (Gi(p, xi, V), Gi(p, yi, xe), Gi(p, _i, z), Gi(p, vi, B), Gi(m, xi, V), Gi(m, yi, xe), Gi(m, _i, z), Gi(m, vi, B), Gi(f, _i, be), Gi(f, vi, R), u.width = Da(be * Bi), u.height = Da(R * Bi), y.forEach(({ _el: e, _show: t, _size: n, _pos: r, side: i }) => {
				if (e != null) {
					if (t) {
						let t = i === 3 || i === 0 ? n : 0, a = i % 2 == 1;
						Gi(e, a ? "left" : "top", r - t), Gi(e, a ? "width" : "height", n), Gi(e, a ? "top" : "left", a ? xe : V), Gi(e, a ? "height" : "width", a ? B : z), Wi(e, ai);
					} else Ui(e, ai);
				}
				...
				let e = z / we, t = B / Te;
				if (N && !Me && j.left >= 0) {
					j.left *= e, j.top *= t, Kt && Yi(Kt, Da(j.left), 0, z, B), qt && Yi(qt, 0, Da(j.top), z, B);
					for (let n = 0; n < Ke.length; n++) {
						let r = Ke[n];
						r != null && (qe[n] *= e, Je[n] *= t, Yi(r, Oa(qe[n]), Oa(Je[n]), z, B));
					}
				}
				if (on.show && !Ne && on.left >= 0 && on.width > 0) {
					on.left *= e, on.width *= e, on.top *= t, on.height *= t;
					for (let e in Nn) Gi(sn, e, on[e]);
				}
				Se = V, Ce = xe, we = z, Te = B;
			}
			Kn("setSize"), Ae = !1;
		}
		be > 0 && R > 0 && (d.clearRect(0, 0, u.width, u.height), Kn("drawClear"), w.forEach((e) => e()), Kn("draw")), on.show && Ne && (cn(on), Ne = !1), N && Me && (On(null, !0, !1), Me = !1), A.show && A.live && Pe && (Dn(), Pe = !1), c || (c = !0, r.status = 1, Kn("ready")), ct = !1, Rt = !1;
	}
	r.redraw = (e, t) => {
	...
	function q(e, n) {
		...
		if (i.from == null) {
			...
			e == S && i.distr == 2 && it > 0 && (n.min = ia(n.min, t[0]), n.max = ia(n.max, t[0]), n.min == n.max && n.max++), k[e] = n, ke = !0, Ht();
		}
	}
	r.setScale = q;
	let Wt, Gt, Kt, qt, Jt, Yt, Xt, Zt, Qt, $t, en, tn, nn = !1, rn = j.drag, J = rn.x, an = rn.y;
	N && (j.x && (Wt = qi(si, m)), j.y && (Gt = qi(ci, m)), D.ori == 0 ? (Kt = Wt, qt = Gt) : (Kt = Gt, qt = Wt), en = j.left, tn = j.top);
	let on = r.select = go({
		show: !0,
		over: !0,
		left: 0,
		...
		top: 0,
		height: 0
	}, e.select), sn = on.show ? qi(oi, on.over ? m : p) : null;
	function cn(e, t) {
		if (on.show) {
			for (let t in e) on[t] = e[t], t in Nn && Gi(sn, t, e[t]);
			t !== !1 && Kn("setSelect");
		}
	}
	r.setSelect = cn;
	function ln(e) {
		if (v[e].show) M && Wi(I[e], ai);
		else if (M && Ui(I[e], ai), N) {
			let t = Ge ? Ke[0] : Ke[e];
			t != null && Yi(t, -10, -10, z, B);
		}
	}
	function un(e, t, n) {
		q(e, {
	...
	function dn(e, t, n, a) {
		...
		}), n !== !1 && Kn("setSeries", e, t), a && Yn("setSeries", r, e, t);
	}
	r.setSeries = dn;
	function fn(e, t) {
		go(x[e], t);
	...
	function pn(e, t) {
		e.fill = Va(e.fill || null), e.dir = va(e.dir, -1), t ??= x.length, x.splice(t, 0, e);
	}
	function mn(e) {
	...
	M && We && ye(ki, F, (e) => {
		j._lock || (Ve(e), vn != null && dn(null, yn, !0, qn.setSeries));
	});
	function xn(e, t, n) {
		let r = b[t];
		n && (e = e / Bi - (r.ori == 1 ? xe : V));
		let i = z;
		r.ori == 1 && (i = B, e = i - e), r.dir == -1 && (e = i - e);
		let a = r._min, o = r._max, s = e / i, c = a + (o - a) * s, l = r.distr;
		return l == 3 ? ja(10, c) : l == 4 ? Fa(c, r.asinh) : l == 100 ? r.bwd(c) : c;
	}
	function Sn(e, n) {
		return ia(xn(e, S, n), t[0], at, ot);
	}
	r.valToIdx = (e) => ia(e, t[0]), r.posToIdx = Sn, r.posToVal = xn, r.valToPos = (e, t, n) => b[t].ori == 0 ? a(e, b[t], n ? De : z, n ? Ee : 0) : o(e, b[t], n ? Oe : B, n ? H : 0), r.setCursor = (e, t, n) => {
		en = e.left, tn = e.top, On(null, t, n);
	};
	function Cn(e, t) {
		Gi(sn, xi, on.left = e), Gi(sn, _i, on.width = t);
	}
	function wn(e, t) {
		Gi(sn, yi, on.top = e), Gi(sn, vi, on.height = t);
	}
	let Tn = D.ori == 0 ? Cn : wn, Y = D.ori == 1 ? Cn : wn;
	function En() {
	...
	function Dn(e, t) {
		if (e != null && (e.idxs ? e.idxs.forEach((e, t) => {
			se[t] = e;
		}) : co(e.idx) || se.fill(e.idx), A.idx = se[0]), M && A.live) {
			for (let e = 0; e < v.length; e++) (e > 0 || i == 1 && !fe) && X(e, se[e]);
			En();
		}
	...
	function On(e, n, a) {
		Qt = en, $t = tn, [en, tn] = j.move(r, en, tn), j.left = en, j.top = tn, N && (Kt && Yi(Kt, Da(en), 0, z, B), qt && Yi(qt, 0, Da(tn), z, B));
		let o, s = at > ot;
		gn = La, _n = null;
		...
		if (en < 0 || it == 0 || s) {
			...
			We && dn(null, yn, !0, e == null && qn.setSeries), A.live && (se.fill(o), Pe = !0);
		} else {
			let e, n, a;
			i == 1 && (e = D.ori == 0 ? en : tn, n = xn(e, S), o = j.idx = ia(n, t[0], at, ot), a = ee(t[0][o], D, c, 0));
			...
			for (let e = +(i == 2); e < v.length; e++) {
				...
				if (Pe = Pe || S != y || x != _, se[e] = x, e > 0 && g.show) {
					...
					if (We && S != null) {
						let t = D.ori == 1 ? en : tn, n = Ta(Ue.dist(r, e, x, _, t));
						if (n < gn) {
							let r = Ue.bias;
							if (r != 0) {
					...
					if (Pe || Ge) {
						...
						if (v = He.fill(r, e), g = He.stroke(r, e), Ge) e == _n && gn <= Ue.prox && (s = c, u = l, d = a, f = o, p = y, m = v, h = g);
							...
							let t = Ke[e];
							t != null && (qe[e] = c, Je[e] = l, $i(t, a, o, y), Zi(t, v, g), Yi(t, Oa(c), Oa(l), z, B));
						}
					}
				}
			}
			if (Ge) {
				...
				if (Pe || (vn == null ? gn <= e : gn > e || _n != vn)) {
					let e = Ke[0];
					e != null && (qe[0] = s, Je[0] = u, $i(e, d, f, p), Zi(e, m, h), Yi(e, Oa(s), Oa(u), z, B));
				}
			}
		}
		if (on.show && nn) {
			if (e != null) {
				let [t, n] = qn.scales, [r, i] = qn.match, [a, o] = e.cursor.sync.scales, s = e.cursor.drag;
				if (J = s._x, an = s._y, J || an) {
					let { left: s, top: u, width: d, height: f } = e.select, p = e.scales[a].ori, m = e.posToVal, h, g, _, v, y, x = t != null && r(t, a), S = n != null && i(n, o);
					x && J ? (p == 0 ? (h = s, g = d) : (h = u, g = f), _ = b[t], v = ee(m(h, a), _, c, 0), y = ee(m(h + g, a), _, c, 0), Tn(ka(v, y), Ta(y - v))) : Tn(0, c), S && an ? (p == 1 ? (h = s, g = d) : (h = u, g = f), _ = b[n], v = te(m(h, o), _, l, 0), y = te(m(h + g, o), _, l, 0), Y(ka(v, y), Ta(y - v))) : Y(0, l);
				} else Pn();
			} else {
				let e = Ta(Qt - Jt), t = Ta($t - Yt);
				if (D.ori == 1) {
					let n = e;
					e = t, t = n;
				}
				J = rn.x && e >= rn.dist, an = rn.y && t >= rn.dist;
				let n = rn.uni;
				n == null ? rn.x && rn.y && (J || an) && (J = an = !0) : J && an && (J = e >= n, an = t >= n, !J && !an && (t > e ? an = !0 : J = !0));
				let r, i;
				J && (D.ori == 0 ? (r = Xt, i = en) : (r = Zt, i = tn), Tn(ka(r, i), Ta(i - r)), an || Y(0, l)), an && (D.ori == 1 ? (r = Xt, i = en) : (r = Zt, i = tn), Y(ka(r, i), Ta(i - r)), J || Tn(0, c)), !J && !an && (Tn(0, 0), Y(0, 0));
			}
		}
		if (rn._x = J, rn._y = an, e == null) {
			if (a) {
				if (Jn != null) {
					let [e, t] = qn.scales;
					qn.values[0] = e == null ? null : xn(D.ori == 0 ? en : tn, e), qn.values[1] = t == null ? null : xn(D.ori == 1 ? en : tn, t);
				}
				Yn(Ti, r, en, tn, z, B, o);
			}
			if (We) {
				let e = a && qn.setSeries, t = Ue.prox;
				vn == null ? gn <= t && dn(_n, yn, !0, e) : gn > t ? dn(null, yn, !0, e) : _n != vn && dn(_n, yn, !0, e);
			}
		}
		Pe && (A.idx = o, Dn()), n !== !1 && Kn("setCursor");
	}
	let kn = null;
	...
	function An(e = !1) {
		e ? kn = null : (kn = m.getBoundingClientRect(), Kn("syncRect", kn));
	}
	function jn(e, t, n, r, i, a, o) {
		j._lock || nn && e != null && e.movementX == 0 && e.movementY == 0 || (Mn(e, t, n, r, i, a, o, !1, e != null), e == null ? On(t, !0, !1) : On(null, !0, !0));
	}
	function Mn(e, t, n, i, a, o, c, l, u) {
		if (kn ?? An(!1), Ve(e), e != null) n = e.clientX - kn.left, i = e.clientY - kn.top;
		else {
			if (n < 0 || i < 0) {
				en = -10, tn = -10;
				return;
			}
			let [e, r] = qn.scales, c = t.cursor.sync, [l, u] = c.values, [d, f] = c.scales, [p, m] = qn.match, h = t.axes[0].side % 2 == 1, g = D.ori == 0 ? z : B, _ = D.ori == 1 ? z : B, v = h ? o : a, y = h ? a : o, x = h ? i : n, S = h ? n : i;
			if (n = d == null ? x / v * g : p(e, d) ? s(l, b[e], g, 0) : -10, i = f == null ? S / y * _ : m(r, f) ? s(u, b[r], _, 0) : -10, D.ori == 1) {
				let e = n;
				n = i, i = e;
			}
		}
		u && (t == null || t.cursor.event.type == Ti) && ((n <= 1 || n >= z - 1) && (n = Xa(n, z)), (i <= 1 || i >= B - 1) && (i = Xa(i, B))), l ? (Jt = n, Yt = i, [Xt, Zt] = j.move(r, n, i)) : (en = n, tn = i);
	}
	let Nn = {
		width: 0,
		height: 0,
	...
	function zn(e, t, n, i, a, o, s) {
		nn = !0, J = an = rn._x = rn._y = !1, Mn(e, t, n, i, a, o, s, !0, !1), e != null && (ye(Di, Li, Bn, !1), Yn(Ei, r, Xt, Zt, z, B, null));
		let { left: c, top: l, width: u, height: d } = on;
		Fn = c, In = l, Ln = u, Rn = d;
	}
	function Bn(e, t, n, i, a, o, s) {
		nn = rn._x = rn._y = !1, Mn(e, t, n, i, a, o, s, !1, !0);
		let { left: c, top: l, width: u, height: d } = on, f = u > 0 || d > 0, p = Fn != c || In != l || Ln != u || Rn != d;
		if (f && p && cn(on), rn.setScale && f && p) {
			let e = c, t = u, n = l, r = d;
			if (D.ori == 1 && (e = l, t = d, n = c, r = u), J && un(S, xn(e, S), xn(e + t, S)), an) for (let e in b) {
				let t = b[e];
				e != S && t.from == null && t.min != La && un(e, xn(n + r, e), xn(n, e));
			}
			Pn();
		} else j.lock && (j._lock = !j._lock, On(t, !0, e != null));
		e != null && (L(Di, Li), Yn(Di, r, en, tn, z, B, null));
	}
	function Vn(e, t, n, r, i, a, o) {
		...
		if (nn) {
			let e = !0, t = !0, n, r;
			D.ori == 0 ? (n = J, r = an) : (n = an, r = J), n && r && (e = en <= 10 || en >= z - 10, t = tn <= 10 || tn >= B - 10), n && e && (en = en < Xt ? 0 : z), r && t && (tn = tn < Zt ? 0 : B), On(null, !0, !0), nn = !1;
		}
		en = -10, tn = -10, se.fill(null), On(null, !0, !0), s && (nn = s);
	}
	function Hn(e, t, n, i, a, o, s) {
		j._lock || (Ve(e), ut(), Pn(), e != null && Yn(Ai, r, en, tn, z, B, null));
	}
	function Un() {
		y.forEach(tl), Fe(r.width, r.height, !0);
	}
	na(Pi, Ri, Un);
	let Wn = {};
	...
	}, N && (ye(Ei, m, zn), ye(Ti, m, jn), ye(Oi, m, (e) => {
		Ve(e), An(!1);
	}), ye(ki, m, Vn), ye(Ai, m, Hn), zc.add(r), r.syncRect = An);
	...
	qn.match.length == 2 && qn.match.push(Z), j.sync = qn;
	let Jn = qn.key, Q = oc(Jn);
	function Yn(e, t, n, r, i, a, o) {
		qn.filters.pub(e, t, n, r, i, a, o) && Q.pub(e, t, n, r, i, a, o);
	}
	Q.sub(r);
	function Xn(e, t, n, r, i, a, o) {
		qn.filters.sub(e, t, n, r, i, a, o) && Wn[e](null, t, n, r, i, a, o);
	}
	r.pub = Xn;
	function Zn() {
		Q.unsub(r), zc.delete(r), ve.clear(), ra(Pi, Ri, Un), l.remove(), F?.remove(), Kn("destroy");
	}
	r.destroy = Zn;
	function Qn() {
		Kn("init", e, t), lt(t || e.data, !1), k[S] ? q(S, k[S]) : ut(), Ne = on.show && (on.width > 0 || on.height > 0), Me = Pe = !0, Fe(e.width, e.height);
	}
	return v.forEach(Xe), y.forEach(et), n ? n instanceof HTMLElement ? (n.appendChild(l), Qn()) : n(r, Qn) : Qn(), r;
}
nl.assign = go, nl.fmtNum = Sa, nl.rangeNum = _a, nl.rangeLog = da, nl.rangeAsinh = fa, nl.orient = lc, nl.pxRatio = Bi, nl.join = xo, nl.fmtDate = Po, nl.tzDate = Io, nl.sync = oc;
{
	nl.addGap = mc, nl.clipGaps = pc;
	let e = nl.paths = { points: Oc };
	e.linear = Mc, e.stepped = Nc, e.bars = Fc, e.spline = Lc;
}
//#endregion
//#region src/App.svelte
var rl = /* @__PURE__ */ lr("<div class=\"error\" role=\"alert\"> <code>apx status</code> if the problem persists.</div>"), il = /* @__PURE__ */ lr("<div class=\"empty-state\"><strong> </strong> <span> </span></div>"), al = /* @__PURE__ */ lr("· <strong> </strong> are excluded from verified totals.", 1), ol = /* @__PURE__ */ lr("<article><strong> </strong><small> </small><em> </em></article>"), sl = /* @__PURE__ */ lr("<button class=\"signals-toggle\" type=\"button\"> </button>"), cl = /* @__PURE__ */ lr("<div class=\"attention-list\"></div> <!>", 1), ll = /* @__PURE__ */ lr("<p class=\"clear\">Requests and optimizers show no active warning signals in this window.</p>"), ul = /* @__PURE__ */ lr("<p class=\"chart-empty\">A trend appears after two time buckets.</p>"), dl = /* @__PURE__ */ lr("<!> <div class=\"metrics\" aria-label=\"Token efficiency summary\"><article><span>Tokens processed</span><strong> <em class=\"metric-unit\">&nbsp;tokens</em></strong><small> </small></article> <article class=\"token-card\"><span>Verified input saved</span><strong> <em class=\"metric-unit\">&nbsp;tokens</em></strong><small>Removed before the model with matching before/after evidence</small></article> <article><span>Verified input reduction</span><strong> </strong><small> </small></article> <article><span>Request health</span><strong> </strong><small> </small></article></div> <article class=\"token-journey\" aria-label=\"Verified input token journey\"><div class=\"journey-heading\"><div><h3>Verified input journey</h3><small>Actual model input plus verified removals; estimates are excluded</small></div> <span class=\"status\"> </span></div> <div class=\"journey-values\"><div><span>Verified baseline input</span><strong> </strong><small>actual input + verified removed</small></div> <span class=\"journey-arrow\" aria-hidden=\"true\">→</span> <div><span>Sent to model</span><strong> </strong><small> </small></div> <span class=\"journey-plus\" aria-hidden=\"true\">+</span> <div class=\"journey-saved\"><span>Removed</span><strong> </strong><small> </small></div></div> <div class=\"journey-track\" aria-hidden=\"true\"><span class=\"journey-sent\"></span> <span class=\"journey-removed\"></span></div> <p class=\"journey-evidence\">Evidence coverage: <strong> </strong> <!></p></article> <div><div class=\"attention-heading\"><h3> </h3><span> </span></div> <!></div> <div class=\"context-strip\" aria-label=\"Usage context\"><div><span>Cache reuse</span><strong> </strong><small> </small></div> <div><span>Estimated spend</span><strong> </strong><small>based on configured model prices</small></div> <div><span>Models active</span><strong> </strong><small> </small></div> <div><span>Tool activity</span><strong> </strong><small> </small></div></div> <div class=\"charts\"><article class=\"chart\"><div class=\"chart-heading\"><div><h3>Token flow</h3><small> </small></div><span class=\"status\"> </span></div><div class=\"chart-key\"><span class=\"key-input\">Input</span><span class=\"key-output\">Output</span></div><div role=\"img\"></div><!></article> <article class=\"chart\"><div class=\"chart-heading\"><div><h3>Savings evidence</h3><small> </small></div><span class=\"status\">explicit</span></div><div class=\"chart-key\"><span class=\"key-verified\">Verified</span><span class=\"key-estimated\">Estimated</span></div><div role=\"img\"></div><!></article></div>", 1), fl = /* @__PURE__ */ lr("<em>tokens</em>"), pl = /* @__PURE__ */ lr("<p class=\"bypass-note\"> </p>"), ml = /* @__PURE__ */ lr("<a class=\"optimizer-link\" target=\"_blank\" rel=\"noopener\"> <span aria-hidden=\"true\">↗</span></a>"), hl = /* @__PURE__ */ lr("<article><div class=\"optimizer-card-heading\"><div><p class=\"optimizer-name\"> </p><small> </small></div> <span> </span></div> <div class=\"optimizer-primary\"><div><span>Verified this window</span><strong> <!></strong></div> <div><span>Native reported total</span><strong> <!></strong></div></div> <div class=\"coverage-row\"><div><span>Evidence coverage</span><strong> </strong></div> <div class=\"coverage-track\" aria-hidden=\"true\"><span></span></div> <small> </small></div> <dl class=\"optimizer-facts\"><div><dt>Native reduction</dt><dd> </dd></div> <div><dt>Native requests</dt><dd> </dd></div> <div><dt>Optimizer latency</dt><dd> </dd></div> <div><dt>Native cost saved</dt><dd> </dd></div></dl> <!> <div class=\"optimizer-card-footer\"><small> </small> <!></div></article>"), gl = /* @__PURE__ */ lr("<article><p class=\"clear\">No optimizer activity or health snapshots in this window yet.</p></article>"), _l = /* @__PURE__ */ lr("<div class=\"optimizer-overview\" aria-label=\"Optimizer measurement summary\"><div><span>Verified savings this window</span><strong> </strong><small> </small></div> <div><span>Evidence coverage</span><strong> </strong><small> </small></div> <div><span>Persistence</span><strong> </strong><small> </small></div></div> <p class=\"optimizer-explainer\">Verified savings below is scoped to the selected window. Native counters are optimizer-reported totals and may cover a longer lifetime, so they are deliberately labeled separately.</p> <div class=\"optimizer-cards\"><!></div>", 1), vl = /* @__PURE__ */ lr("<div class=\"health-row\"><strong> </strong><span> </span><small> </small></div>"), yl = /* @__PURE__ */ lr("<div class=\"health-list\"></div>"), bl = /* @__PURE__ */ lr("<p class=\"clear\">No model activity in this window.</p>"), xl = /* @__PURE__ */ lr("<div class=\"health-row session-row\"><strong> </strong><span> </span> <small> </small></div>"), Sl = /* @__PURE__ */ lr("<p class=\"clear\">No sessions in this window.</p>"), Cl = /* @__PURE__ */ lr("<div class=\"stored-grid\" aria-label=\"Persisted activity\"><article><div class=\"attention-heading\"><h3>Local history</h3><span> </span></div> <div class=\"storage-value\"> </div> <small> </small></article> <article><div class=\"attention-heading\"><h3>Top models</h3><span class=\"status\"> </span></div> <!></article> <article><div class=\"attention-heading\"><h3>Recent sessions</h3><span class=\"status\"> </span></div> <!></article></div>"), wl = /* @__PURE__ */ lr("<section class=\"overview\" aria-label=\"Gateway overview\"><div class=\"heading\"><div><p class=\"eyebrow\">LeanRelay · token efficiency</p> <h2> </h2></div> <div class=\"refresh-state\"><span aria-live=\"polite\"> </span> <button class=\"refresh-button\" type=\"button\" aria-label=\"Refresh dashboard data\">Refresh</button></div></div> <!> <div class=\"view-tabs\" aria-label=\"Dashboard views\" role=\"tablist\"><button type=\"button\" role=\"tab\">Overview</button> <button type=\"button\" role=\"tab\">Optimizers</button> <button type=\"button\" role=\"tab\">Activity</button></div> <!></section>");
function Tl(e, t) {
	Oe(t, !1);
	...
	function L() {
		...
		!Z(N) || !Z(P) || (F?.destroy(), ce?.destroy(), F = void 0, ce = void 0, Z(N).replaceChildren(), Z(P).replaceChildren(), e.length >= 2 && (F = new nl(ye(Z(N), [{
			label: "input tokens",
			stroke: "#7aa2ff",
			width: 2
		}, {
			...
			t,
			n
		], Z(N))), r.length >= 2 && (ce = new nl(ye(Z(P), [{
	...
	async function be(e) {
		e !== Z(M) && (Z(N) && le?.unobserve(Z(N)), Z(P) && le?.unobserve(Z(P)), F?.destroy(), ce?.destroy(), F = void 0, ce = void 0, G(M, e), await Kn(), e === "overview" && (Z(N) && le?.observe(Z(N)), Z(P) && le?.observe(Z(P)), L()));
	}
	async function R() {
		...
		try {
			...
			}), G(se, n.includes("usage")), G(oe, n.length ? `Some data is temporarily unavailable: ${n.join(", ")}` : ""), G(j, /* @__PURE__ */ new Date()), await Kn(), L();
		} catch (e) {
	...
	var B = wl(), Se = K(B), Ce = K(Se), we = q(K(Ce), 2), Te = K(we, !0);
	V(we), V(Ce);
	...
	var Me = q(Se, 2), Ne = (e) => {
		var t = rl(), n = K(t);
		xe(2), V(t), cn(() => $(n, `${Z(oe) ?? ""}. Available sections remain visible; use `)), dr(e, t);
	};
	xr(Me, (e) => {
		Z(oe) && e(Ne);
	});
	...
	var Re = q(Pe, 2), ze = (e) => {
		...
		var ze = q(Le), Be = q(ze), Ve = (e) => {
			var t = al(), n = q(Ut(t)), r = K(n);
			V(n), xe(), cn((e) => $(r, `${e ?? ""} estimated tokens`), [() => (Z(u), Q(() => I(Z(u))))]), dr(e, t);
		};
		xr(Be, (e) => {
			Z(u) > 0 && e(Ve);
		}), V(Ie), V(ye);
		...
		var Xe = q(We, 2), Ze = (e) => {
			...
			var r = q(n, 2), i = (e) => {
				var t = sl(), n = K(t, !0);
				V(t), cn(() => {
					Hr(t, "aria-expanded", Z(A)), $(n, (Z(A), Z(O), Q(() => Z(A) ? "Show only the first signal" : `Review all ${Z(O).alerts.length} signals`)));
				}), er("click", t, () => G(A, !Z(A))), dr(e, t);
			};
			xr(r, (e) => {
		...
		var W = q(yt, 2), At = K(W), jt = K(At), Mt = q(K(jt)), Nt = K(Mt);
		V(Mt), V(jt), xe(), V(At);
		var Pt = q(At, 2);
		let Ft;
		qr(Pt, (e) => G(P, e), () => Z(P));
		...
		}), V(W), V(vt), cn((e, t, n, r, i, a, s, c, l, u, d, f, p, m, h, x, S, C, w, T, D, k, ie, ae, oe, A, M, N, P, F) => {
			$(te, e), $(re, `Actually sent: ${t ?? ""} input + ${n ?? ""} output`), $(j, r), $(ce, i), $(fe, `${a ?? ""} removed from ${s ?? ""} baseline input tokens`), he = Ir(me, 1, "", null, he, { healthy: Z(y) && Z(v) === 0 && !Z(se) }), $(ge, Z(b)), $(ve, `${c ?? ""} requests · p95 ${l ?? ""}`), $(R, Z(E)), $(Ce, u), $(Ee, d), $(De, f), $(Ae, p), $(Me, m), Rr(Pe, `width:${Z(g)}%`), Rr(Fe, `width:${Z(_)}%`), $(Re, h), $(ze, ` · ${x ?? ""} of ${S ?? ""} optimizer attempts supplied valid before/after token counts. `), Ue = Ir(He, 1, "attention", null, Ue, { "has-signals": Z(O).alerts?.length }), $(Ke, (Z(O), Q(() => Z(O).alerts?.length ? "Needs attention" : "No action needed"))), Je = Ir(qe, 1, "status", null, Je, C), $(Ye, `${Z(O), Q(() => Z(O).alerts?.length || 0) ?? ""} signals`), $(rt, w), $(at, `tokens read · ${T ?? ""} written`), $(U, D), $(ut, k), $(ft, (Z(o), Q(() => Z(o)[0]?.model || "no model activity"))), $(ht, ie), $(_t, `tool calls · ${ae ?? ""} streamed requests`), $(Ct, `${oe ?? ""} input · ${A ?? ""} output tokens in this window`), $(Tt, Z(E)), Dt = Ir(Et, 1, "plot", null, Dt, { empty: Z(ee).length < 2 }), Hr(Et, "aria-label", M), $(Nt, `${N ?? ""} verified · ${P ?? ""} estimated tokens excluded`), Ft = Ir(Pt, 1, "plot", null, Ft, { empty: Z(ne).length < 2 }), Hr(Pt, "aria-label", F);
		}, [
			() => (Z(c), Q(() => I(Z(c)))),
		...
		var t = _l(), n = Ut(t), r = K(n), i = q(K(r)), a = K(i);
		V(i);
		var o = q(i), s = K(o);
		V(o), V(r);
		...
		var C = q(n, 4), T = K(C), E = (e) => {
			...
			Tr(Ut(t), 1, () => Z(w), (e) => e.name, (e, t) => {
				...
				var _e = q(se, 2), ve = (e) => {
					var n = pl(), r = K(n);
					V(n), cn((e) => $(r, `Top bypass: ${Z(t), Q(() => Z(t).measurement.bypass_reasons[0].reason) ?? ""} (${e ?? ""})`), [() => (Z(t), Q(() => I(Z(t).measurement.bypass_reasons[0].count)))]), dr(e, n);
				};
				xr(_e, (e) => {
				...
				var R = q(L, 2), z = (e) => {
					var t = ml(), r = K(t);
					xe(), V(t), cn(() => {
						Hr(t, "href", (Yn(Z(n)), Q(() => Z(n).href))), $(r, `${Yn(Z(n)), Q(() => Z(n).label) ?? ""} `);
					}), dr(e, t);
				};
				xr(R, (e) => {
					Z(n) && e(z);
				}), V(ye), V(o), cn((e, n, r, i, c, l, u, f, _, v, y) => {
					s = Ir(o, 1, "optimizer-card", null, s, { down: Z(t).snapshot && !Z(t).snapshot.reachable }), $(d, (Z(t), Q(() => Z(t).name))), $(p, (Z(t), Q(() => Z(t).snapshot?.reachable ? Z(t).reported?.saved == null ? "Connected; native counters unavailable" : "Connected and reporting" : Z(t).snapshot ? "Not reachable at last check" : "No health snapshot in this window"))), h = Ir(m, 1, "status", null, h, {
						ok: Z(t).snapshot?.reachable,
						warn: !Z(t).snapshot,
						fail: Z(t).snapshot && !Z(t).snapshot.reachable
					}), $(g, (Z(t), Q(() => Z(t).snapshot?.reachable ? "reachable" : Z(t).snapshot ? "unreachable" : "not checked"))), $(b, `${e ?? ""} `), T = Ir(w, 1, "", null, T, { unavailable: Z(t).reported?.saved == null }), $(E, `${n ?? ""} `), $(ne, r), Rr(ie, `width:${Z(a) || 0}%`), $(oe, `${i ?? ""} verified · ${c ?? ""} estimated · ${l ?? ""} unavailable`), $(M, u), $(F, f), $(fe, _), $(ge, v), $(be, y);
				}, [
					...
					() => (Yn(Z(a)), Q(() => Z(a) == null ? "not measured" : `${Z(a).toFixed(0)}%`)),
					() => (Yn(Z(i)), Q(() => I(Z(i)))),
		...
		var g = q(p, 2), _ = (e) => {
			var t = yl();
			Tr(t, 5, () => Z(o), (e) => e.model, (e, t) => {
				var n = vl(), r = K(n), i = K(r, !0);
				V(r);
				var a = q(r), o = K(a);
				V(a);
				var s = q(a), c = K(s);
		...
		var C = q(b, 2), w = (e) => {
			var t = yl();
			Tr(t, 5, () => Z(re), (e) => e.session_id, (e, t) => {
				var n = xl(), r = K(n), i = K(r, !0);
				V(r);
				var a = q(r), o = K(a);
				V(a);
				var s = q(a, 2), c = K(s);
				V(s), V(n), cn((e, n, a, s) => {
					Hr(r, "title", (Z(t), Q(() => Z(t).session_id))), $(i, (Z(t), Q(() => Z(t).last_model || "unknown model"))), $(o, `${e ?? ""} requests`), $(c, `${Z(t), Q(() => Z(t).chain_mode || "direct") ?? ""} · ${n ?? ""} processed
                · ${a ?? ""} verified saved · ${s ?? ""}`);
				}, [
					() => (Z(t), Q(() => I(Z(t).requests))),
					() => (Z(t), Q(() => I(Number(Z(t).tokens_in || 0) + Number(Z(t).tokens_out || 0)))),
	...
	xr(Re, (e) => {
		...
		$(Te, Z(M) === "overview" ? "Token efficiency overview" : Z(M) === "optimizers" ? "Optimizer details" : "Persisted activity"), De = Ir(H, 1, "status", null, De, {
			ok: !Z(ae) && !Z(oe),
			warn: Z(ae) || !!Z(oe) && Z(y),
			fail: !!Z(oe) && !Z(y)
		}), $(Ae, e), je.disabled = Z(ae), Hr(Fe, "aria-selected", Z(M) === "overview"), Hr(Ie, "aria-selected", Z(M) === "optimizers"), Hr(Le, "aria-selected", Z(M) === "activity");
	}, [() => (Z(oe), Z(ae), Z(j), Q(() => Z(oe) ? "partial data" : Z(ae) ? "refreshing" : Z(j) ? `updated ${Z(j).toLocaleTimeString([], {
		hour: "2-digit",
		minute: "2-digit"
	})}` : "ready"))]), er("click", je, R), er("click", Fe, () => be("overview")), er("click", Ie, () => be("optimizers")), er("click", Le, () => be("activity")), dr(e, B), ke();
}
tr(["click"]);
//#endregion
//#region src/main.js
var El = "svelte-uplot", Dl = document.querySelector("#svelte-overview");
Dl && (Dl.replaceChildren(), mr(Tl, { target: Dl }));
//#endregion
export { Tl as App, El as dashboardBuild };
